...
# -*- coding: UTF-8 -*-
'''
修复历史开发库中审计用户外键仍指向旧 UUID 用户表的问题。
@Project : QWeb
@File : 0003_repair_legacy_user_foreign_keys.py
@Author : Qintsg
...
def repair_legacy_user_foreign_keys(apps, schema_editor) -> None:
    ...
    if not _table_exists(schema_editor, "accounts_legacy_user_id_map"):
        return
    _repair_user_foreign_key(schema_editor, "audit_log", "user_id")
    _repair_user_foreign_key(schema_editor, "user_login_logs", "user_id")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("audit", "0002_repair_legacy_login_log_table"),
    ]
