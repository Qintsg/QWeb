...
export default {
  ...
  auth: {
    ...
    bootstrapOwnerTitle: "Create Owner Account",
    bootstrapOwnerSubtitle: "No site owner account was detected. Create the first account to receive the owner role automatically.",
    createOwnerAccount: "Create owner account",
    bootstrapOwnerFailed: "Failed to create owner account. Please check your input",
